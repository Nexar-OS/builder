...
# Setup grub
sudo chroot $MOUNT sh -c "grub-install --target=x86_64-efi --efi-directory=\"/boot/efi\" --bootloader-id=\"test\" --removable"
sudo chroot $MOUNT sh -c "grub-mkconfig -o /boot/grub/grub.cfg"
